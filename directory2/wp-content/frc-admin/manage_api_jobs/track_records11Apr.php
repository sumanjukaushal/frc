<?php
    //Script URL: http://freerangecamping.co.nz/mobile/wp-content/manage_api_jobs/track_records.php
    require_once("../../wp-config.php");
    require_once('../../wp-load.php');
    $postType = isOldTheme() ? 'ait-dir-item' : 'ait-item';
	$appendToTable = '_11apr';//_2feb
   ...
   function frcExport($offset = 0){
        ...
        foreach ($items->posts as $key => $item) {
			...
			$item->post_content = str_replace("\r\r","\n",$item->post_content);
			$item->post_content = str_replace("\r","\n",$item->post_content);
			$headings = array(
								'FACILITIES',
								'COST' ,
			...
			$new_headings = array(
								...
								'\n<strong>RULES</strong>',
								'\n<span style="font-weight:bold"><b>FEES</b><span>',
								'\n',
