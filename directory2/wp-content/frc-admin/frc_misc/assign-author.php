<html>
    <head>
        ...
        ?>
    <body>
        <h3 style='padding-left:20px;'>&raquo;&nbsp;Change Author</h3><br/>
                ...
                foreach($postDataRes as $key => $postData){
                    ...
                    $innerHTML.="
                                <tr style='background-color:$bgColor'>
                                    ...
                                    <td style='text-align: center;'><input type=checkbox name=item_checked[$postData->ID] class='case' checked='checked'></td>
                                </tr>";
                }
...
FORM_HTML;
            ...
            if(array_key_exists('item_checked',$_REQUEST) && is_array($_REQUEST['item_checked']) && !empty($_REQUEST['item_checked']) && $_REQUEST['author']!= 0){
                ...
                if(count($successIDs)){
                    ...
                    echo "Author updated for the following item ids $updatedIDs<br/>";
                }
            }else{
                echo "Please select both author and items";
            }
        }
    ?>
    </body>
