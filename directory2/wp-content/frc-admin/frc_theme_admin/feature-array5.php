...
<?php
	...
	$image2 = array_combine($featureArr, $addnlArr);
	$filename = NULL;
...
?>
<a href="feature-array-download4.php?file=feature-array.php" target='_blank'>Download file</a>
<?php
	ob_start();
	echo "<pre>";
	echo "&lt;?php\n\t return array(";
