<?php
	//Calling URL: https://www.freerangecamping.co.nz/directory/wp-content/wlm_sync/wlm_sync_employee_capabilities.php
    ...
    $premMembers = array(13337, 14659, 15605, 36686, 42559);//22840
	//$premMembers = array(13337);
    ...
    //SELECT * FROM `gwr_usermeta` WHERE `user_id` IN (13337) AND meta_key like '%_capabilities'
    ...
    function frc_sync_cap($source, $userID, $dataArr){
		...
		*/
		...
		//-----------------------------
		$employeePermArr = array('administrator' => 1, 'admin_role' => 1, 'create_pages' => 1, 'create_posts' => 1);
		$employeePermArr = array('administrator' => 1, 'admin_role2' => 1);
		//$employeePermArr = array('administrator' => 1);
