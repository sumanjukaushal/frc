<script type='text/javascript'>
    var directory_7_show = [
                        //directory_7: dollar_25plus [Caravan Parks] 
                        'Address',                  //1
                        'Latitude',                 //2
                        'Longitude',                //3
                        'Streetview',               //4                        
                        ...
                        'Email',                    //6
                        'Show Email',
                        'Contact owner button',     //7
                        'Web',                      //8
                        'Web Link Label',
                        //'map',                    //11 map should appear
                        
                        
                        //FREE RANGE CUSTOM FIELDS
                        'Suburb',
                        'State',
                        'Pin Code',
                        'Discount',                 //13
                        ...
                        'Offer',                    //15
                        'Offer Detail',             //16
                        'Season Rate Apply',        //New
                        'Season Rate Details',      //New
                        //'pricing',                  //9 need to check
                        'Pricing Detail',           //10
                        'Booking Link',             //12
